# Contributing to igsdk

Thank you for your interest in contributing to the igsdk project! This document provides guidelines and instructions for contributing to this project.
...
1. **Fork and clone the repository:**
   ```bash
   git clone https://github.com/YOUR-USERNAME/igsdk.git
   cd igsdk
   ```

2. **Add the upstream remote:**
   ```bash
   git remote add upstream https://github.com/itential/igsdk.git
   ```
...
Thank you for contributing to igsdk!
